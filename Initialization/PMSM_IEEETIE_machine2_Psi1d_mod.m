classdef PMSM_IEEETIE_machine2_Psi1d_mod < PMSMBase2
    methods
        function obj = PMSM_IEEETIE_machine2_Psi1d_mod()            
            m = 5;
            pp = 8;
            ...
            Psi_vec = [0.0115*0.8; 0.0018; 0; 0];
            TPsi_vec = [0.0122*0.8; 0.0005; 0.0001; 0];
